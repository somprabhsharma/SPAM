...
padding-right:250px;">
 <table border="2">
  <caption> <h2>EIC Department Guides</h2></caption>

    <tr>
    <th> S.No.</th>
    
    <th><b>List of all registered EIC Guides</b> </th>
    <th><b>Designation</b></th>
    </tr>
  
<?php
$q= "select * from spam_sign_in where category='guide' and dept='EIC' and value='1' ";
$sql=mysql_query($q);
$count=1;
