...
padding-right:250px;">
 <table border="2">
 <caption> <h2>IT Department Guide</h2></caption>
    <tr>
    <th> S.No.</th>
    
    <th><b>List of all registered IT Guides</b> </th>
    <th><b>Designation</b></th>
    </tr>
  
<?php
$q= "select * from spam_sign_in where category='guide' and dept='IT' and value='1' ";
$sql=mysql_query($q);
$count=1;
