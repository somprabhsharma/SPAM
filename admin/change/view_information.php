...
include 'include/connect.php';//select the table 
		...
		$sql="SELECT * FROM information where category='co-ordinator'";
	
	$result = mysql_query($sql);
	
?>
<div id="wrapper">
<span><big> <h1><font color="#000">Information</font></h1></big> </span> <br /><br>
<a href="information_updates.php"><font size="+1"> BACK </font></a>
...
<table border="1" bordercolor="#8D4747" align="center" style=" width:100px;">
    ...
    <th><font size="+2" color="#8F4747">About the Website</font></th>
       <th><font size="+2" color="#8F4747">About the project</font></th>
