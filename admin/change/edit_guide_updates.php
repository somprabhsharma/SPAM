...
<?php
	...
	{
		$query1="update updates set project='$project',synopsis='$synopsis',reg_date='$reg_date',ppt_date='$ppt_date',report_date='$report_date' where id='$id2'";
		$sql1=mysql_query($query1);
		
		if($sql1)
			{
				echo '<script> alert("You Have Successfully Updated Your Details!!")</script>';								
				echo "<script>window.location='view_guide_updates.php'</script>";
			}
		else
			{
