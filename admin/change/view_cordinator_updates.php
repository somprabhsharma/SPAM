...
<a href="home.php"> <font size="+1">BACK</font> </a>
<br /><br>
<table border="1" bordercolor="#8D4747" align="center" style=" width:100%">
    ...
    <th><font size="+2" color="#8F4747">reg_date</font></th>
    	...
    	<th><font size="+2" color="#8F4747">guide_all</font></th>
...
?>
           ...
           <td>
           		 <form method="get" action="edit_cordinator_updates.php"> 
...
if($result)
{
	echo "<script>window.location='view_cordinator_updates.php'</script>";
}
else
{
	echo "not deleted";
