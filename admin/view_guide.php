...
include 'include/connect.php';//select the table 
		...
		$sql="SELECT * FROM spam_sign_in where category='guide'";
	
	$result = mysql_query($sql);
	
?>
<div id="wrapper" style="background-color:#E7E7E7">
<span><big> <h1><font color="#000">List of Guide</font></h1></big> </span> 
<a href="guide.php"> BACK </a>
...
$del="Delete from spam_sign_in where id='$hide'";
...
if($result)
{
	echo "<script>window.location='view_guide.php'</script>";
}
else
{
	echo "not deleted";
