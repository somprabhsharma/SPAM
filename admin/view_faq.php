...
include 'include/bsr_connectivity.php';//select the table 
		...
		$sql="SELECT * FROM bsr_admin_panel where category='faq'";
	
	$result = mysql_query($sql);
	
?>
<div id="wrapper" style="background-color:#E7E7E7">
<span><big> <h1><font color="#000">FAQ Detail</font></h1></big> </span> 
<a href="faq.php"> BACK </a>
...
<table border="1" bordercolor="#8D4747" align="center" style=" width:100px;">
    ...
    <th><font size="+2" color="#8F4747">Type of content</font></th>
...
$del="Delete from bsr_admin_panel where id='$hide'";
