...
include 'include/connect.php';//select the table 
		...
		$sql="SELECT * FROM spam_guide_predefine ";
	
	$result = mysql_query($sql);

?>
<div id="wrapper" >
<span><big> <h1><font color="#000">Guides List</font></h1></big> </span> 
...
?>
           ...
           <td>
           		 <form method="get" action="edit_guide.php"> 				
...
$del="Delete from spam_guide_predefine where id='$hide'";
