...
?>
       ...
       <div id="wrapper"> 	
        		...
        		<form method="get">
                        ...
                        <br>
        		<a href="prochange.php" style=" color:white;" > BACK </a>
                    <!--first table created-->
                    <table style="margin-left:20px;">                      
                                    ...
                                    <tr><td style="width:180px; height:35px;"/><?php echo $data[41]; ?></td></tr>
                                    
                                    <tr><td><font size="+2" color="#000">Project Name:</font></td></tr>
                                    <tr><td style="width:250px; height:35px;" ><input type="text" value="<?php echo $data[1]; ?>" name="pronm"  style="width:250px; height:40px;"/></td></tr>
...
<?php
	...
	@$update_name=trim($_GET['pronm']);
	
	
	if(isset($_GET['update1']))
	{
	;
		$query1="update stud_reg set project_name='$update_name' where id='$id2'";
		...
		if($sql1)
			{
				...
				echo "<script>window.location='prochange.php'</script>";
			}
		else
			{
