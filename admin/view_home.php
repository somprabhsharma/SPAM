...
include 'include/connect.php';//select the table 
		...
		$sql="SELECT * FROM spam_predefine ";
	
	$result = mysql_query($sql);

?>
<div id="wrapper" ">
<span><big> <h1><font color="#000">Co-ordinators List</font></h1></big> </span> 


<a href="precord.php"> BACK </a>
...
<table border="1" bordercolor="#8D4747" align="center" style=" width:100%">
    ...
    <th><font size="+2" color="#8F4747">Names</font></th>
    
    <th><font size="+2" color="#8F4747">Email</font></th>
	<th><font size="+2" color="#8F4747">Status</font></th>
...
?>
           ...
           <td>
           		 <form method="get" action="edit_home.php"> 				
...
$del="Delete from spam_predefine where id='$hide'";
