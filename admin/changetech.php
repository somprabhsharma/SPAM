...
?>
       ...
       <div id="wrapper"> 	
        		...
        		<form method="get">
                        ...
                        <br>
        		<a href="change.php" style=" color:white;" > BACK </a>
                    <!--first table created-->
                    <table style="margin-left:20px;">                      
                                    ...
                                    <tr><td><font size="+2" color="#000">Technology:</font></td></tr>
                                    <tr><td style="width:250px; height:35px;" ><input type="text" value="<?php echo $data[42]; ?>" name="tech"  style="width:250px; height:40px;"/></td></tr>
...
<?php
	...
	@$update_name=trim($_GET['tech']);
	
	
	if(isset($_GET['update1']))
	{
	;
		$query1="update stud_reg set technology='$update_name' where id='$id2'";
