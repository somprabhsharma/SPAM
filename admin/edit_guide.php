...
<p><?php
	@$id = $_GET['edit_hide'];
	$query = "select * from spam_guide_predefine where id='$id'";
...
?>
       ...
       <div id="wrapper"> 	
        		...
        		<form method="get">
                        ...
                        <br>
        		<a href="view_preguide.php"> BACK </a>
                    <!--first table created-->
...
<?php
	...
	if(isset($_GET['update1']))
	{
		...
		$query1="update spam_guide_predefine set name='$update_name',email='$update_email' where id='$id2'";
	...
	else
	{
		...
		$query1="update spam_guide_predefine set name='$update_name',designation='$update_desig',email='$update_email' where id='$id2'";
		$sql1=mysql_query($query1);
		$data1=mysql_fetch_array($sql1);
	}
		if($sql1)
