...
-->        </select>
        ...
        <tr><td>
            ...
            <input type="submit" name="submit2" value="submit" style="width:100px; height:30px;">
             <a href="view_guide.php" style="width:100px; height:30px;"> View </a>
             </td>
    ...
    <?php
		$divi=$_GET['Select_Box'];
				if(isset($_GET['view2']))
				{
					...
					$query="select content from spam_admin_panel where category='guide' and typeofcontent='$divi'";
				...
				
				{
					...
					$query="insert into spam_admin_panel values('','$divi','$con','guide','$file_name',now(),'0')";
					mysql_query($query);
				}
				?>
                </div>
