...
?>
<div id="c" style="padding-left:250px; padding-right:250px;">
  <table border="2">
    <tr>
    <th > S.No.</th>
    
    <th ><b>List of all registered guides</b> </th>
    <th><b>Designation</b></th>
    </tr>
<?php
$q= "select * from spam_sign_in where category='guide' and value='1'";
$sql=mysql_query($q);
$count=1;
