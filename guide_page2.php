...
{
$f=$_POST['checkboxlist'];
$r=$_POST['hiddeng'];
$s="UPDATE spam_student SET 'guide'= [$r] WHERE t_leader_id= '$f'";
$sql2=mysql_query($s);
}
?><?php */?>
<div id="c" style="height:auto;">
<?php
$pn1=$_SESSION['email'];
...
<th  height="20px" align="center">Synopsis</th>
...
<td>
 <?php
	...
	<a href="Documents/synopsis/<?=$s?>" target="_blank" ><button disabled>Download</button></a> 
	<?php
	}
	else
	{
	?>
	<a href="Documents/synopsis/<?=$s?>" target="_blank" ><button>Download</button></a> 
	<?php
	}
	?>
	</td>
...
<p><h3>Send Email to Team leader to submit their Synopsis...</h3></p>
<?php
...
<div id="td" align="center"><h1><a href="guide_page3.php"> continue...</a></h1></div>
