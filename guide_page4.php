...
<div align="center"><b>
Download report&raquo; </b>
<?php
$q1 = $result["report"];
if($q1==null)
{
?>
<a href="Documents/Report/<?=$$q1?>" target="_blank" ><button disabled>Download</button></a> 
<?php
}
else
{
?>
<a href="Documents/Report/<?=$$q1?>" target="_blank" ><button>Download</button></a>
<?php
}
?>
...
$mail->Body    = 'Dear Students, <br> <br> Here by you are inform that your Report has not been submitted yet.<br> so kindly submit your report before last date.<br></br>From<br>'.$gu.'</br>';
...
echo "<script>alert('Mail has been send');window.location.href='guide_page4.php';</script>";
}
?>
<?php
}
...
{
?>
<a href="Documents/Project/<?=$$q2?>" target="_blank" ><button disabled>Download</button></a> 
<?php
}
else
{
?>
<a href="Documents/Project/<?=$$q2?>" target="_blank" ><button>Download</button></a>
<?php
}
?>
<p><h3>Send Email to Team leader to submit their Project...</h3></p>
<?php
...
$mail->Body    = 'Dear Students, <br> <br> Here by you are inform that your Project has not been submitted yet.<br> so kindly submit your project before last date.<br></br>From<br>'.$gu.'</br>';
...
<hr />
<div align="center"><b>
Download database&raquo; </b>
<?php
$q3 = $result["database"];
if($q3==null)
{
?>
<a href="Documents/Database/<?=$$q3?>" target="_blank" ><button disabled>Download</button></a> 
<?php
}
else
{
?>
<a href="Documents/Database/<?=$$q3?>" target="_blank" ><button>Download</button></a>
<?php
}
?>

<p><h3>Send Email to Team leader to submit their Database...</h3></p>
<?php
...
$mail->Body    = 'Dear Students, <br> <br> Here by you are inform that your Database has not been submitted yet.<br> so kindly submit your database before last date.<br></br>From<br>'.$gu.'</br>';
...
<div id="td" align="center"><h1><a href="guide_marks.php"> continue...</a></h1></div>
